...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="/mycart/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="/mycart/css/purchase.sop.css" />
   <title>订单成功页面 - 尚商商城</title>
   <script type="text/javascript" src="/mycart/js/jquery-1.2.6.min.js"></script>
   <script type="text/javascript" src="/mycart/js/base-2011.js" charset="utf-8"></script>
   <script type="text/javascript" src="/mycart/js/jquery.cookie.js" charset="utf-8"></script>
...
<div class="w" id="headers">
		<div id="logo"><a href="http://www.jd.com/"><img alt="尚商商城" src="/mycart/images/reglogo.png"></a></div>
