...
function search(a) {
    var b = "http://www.atguigu.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    for (var h = 0; h < e.length; h++)
        d = this.FN_GetCompatibleData(e[h]), f.push('<div class="fore'), f.push(h + 1), f.push('" width="'), f.push(d.width), f.push('" height="'), f.push(d.height), f.push('"><a target="_blank" href="../../js/'), f.push(d.href), f.push('" title="'), f.push(d.alt), f.push('"><img src="'), 0 == h ? f.push(d.src) : (f.push('/images/blank.gif" style="background:url('), f.push(d.src), f.push(") no-repeat center 0;")), f.push('" width="'), f.push(d.width), f.push('" height="'), f.push(d.height), f.push('" /></a></div>');
