...
function regist() {
    return location.href = "/user/reg.html";
}
...
function setRandomAds(a, b, c, d) {
    ...
    f && (d && screen.width >= 1280 ? (f.width = f.width2, f.url = f.url2) : (f.width = f.width, f.url = f.url), e = "<a href='../../js/" + f.link + "' target='_blank'><img width='" + f.width + "' height='" + f.height + "' alt='" + f.alt + "' app='image:poster' src='../../js/" + f.url + "' /></a>", g && (g.innerHTML = e))
}
function sBuilder() {
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    for (var l = 0; l < h.length; l++)
        d = h[l], e = k ? d.widthB : d.width, f = k ? d.heightB : d.height, g = k ? d.srcB : d.src, i.push('<div class="fore'), i.push(l + 1), i.push('"><a target="_blank" href="../../js/'), i.push(d.href), i.push('"><img data-img="2" src="../../js/'), i.push(g), i.push('" width="'), i.push(e), i.push('" height="'), i.push(f), i.push('" alt="'), i.push(d.alt), i.push('" /></a></div>');
...
if (function(a) {
    ...
    a.fn.jdSlide = function(b) {
        var c, d, e, f = a.extend({width: null,height: null,pics: [],index: 0,type: "num",current: "curr",delay1: 100,delay2: 5e3}, b || {}), g = this, h = 0, i = !0, j = !0, k = f.pics.length, l = function() {
            var b = "<ul style='position:absolute;top:0;left:0;'><li><a href='../../js/" + f.pics[0].href + "' target='_blank'><img src='../../js/" + f.pics[0].src + "' width='" + f.width + "' height='" + f.height + "' /></a></li></ul>";
        ...
        var m = function() {
            ...
            for (var b, d, h = 0; k > h; h++) {
                switch (b = h == f.index ? f.current : "", f.type) {
                    ...
                    case "string":
                        ...
                        break;
                    case "image":
                        d = "<img src='../../js/" + f.pics[h].breviary + "' />"
                }
                a.push("<span class='"), a.push(b), a.push("'><a href='../../js/"), a.push(f.pics[h].href), a.push("' target='_blank'>"), a.push(d), a.push("</a></span>")
            }
            ...
            for (var a = [], b = 1; k > b; b++)
                a.push("<li><a href='../../js/"), a.push(f.pics[b].href), a.push("' target='_blank'><img src='../../js/"), a.push(f.pics[b].src), a.push("' width='"), a.push(f.width), a.push("' height='"), a.push(f.height), a.push("' /></a></li>");
