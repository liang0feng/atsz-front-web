...
function getCheckCodeTemplate(encryptClientInfo) {
	...
	return "<span class='identifying-code'>" + "<img id='orderCheckCodeImg' src='../../js/" + checkCodeUrl + "' onclick='getNextCheckCode()' "
...
function operate_presaleMobile(thisObj) {
	if ($("#presaleMobile input").size() > 0) {// 点击保存
		...
		if ($("#cancelOperatePresaleMob").size() > 0) {
			...
			var copm = $("<a href=../../js//"#none/" class=\"a-link\" id=\"cancelOperatePresaleMob\">取消</a>");
