...
//        var imgStr = isItemOver ? '<img height="100" width="100" src="../../js/${pageConfig.FN_GetImageDomain(list.skuId)}n4/${list.imgUrl}">' : '<img height="130" width="130" src="../../js/${pageConfig.FN_GetImageDomain(list.skuId)}n3/${list.imgUrl}">';
//        // 无货推荐列表[老服务]
//        var noItem_TPL_OLD = '{for list in html}'
//            +'<li class="fore fore${list_index}" data-push="${}">'
//            +'  <div class="p-img">'
//            +'      <a target="_blank" href="../../js/${list.skuId}.html">'+imgStr+'</a>'
//            +'  </div>'
//            +'  <div class="p-name">'
//            +'      <a target="_blank" title="${list.name}" href="../../js/${list.skuId}.html">${list.Name}</a>'
//            +'  </div>'
//            +'  <div class="p-price">'
...
//        });
    ...
    itemOver: function() {
        ...
        var listBrosweBroswe_TPL = '<li onclick="reClick(1, '+pageConfig.product.skuid+',\'${wid}#${wmeprice}\', [#]);">'
            +'  <div class="p-img">'
            +'      <a target="_blank" title="${name}" href="../../js/${wid}.html"><img height="100" width="100" alt="${name}" src="../../js/${pageConfig.FN_GetImageDomain(wid)}n4/${imgurl}"></a>'
            +'  </div>'
            +'  <div class="p-name">'
            +'      <a target="_blank" title="${name}" href="../../js/${wid}.html">${name}</a>'
            +'  </div>'
            +'  <div class="p-price">'
    ...
    noItemNoData: function( isItemOver ) {
        ...
        var imgStr = isItemOver ? '<img height="100" width="100" src="../../js/${pageConfig.FN_GetImageDomain(list.wid)}n4/${list.imgurl}">' : '<img height="130" width="130" src="../../js/${pageConfig.FN_GetImageDomain(list.wid)}n3/${list.imgurl}">';
        // 无货推荐列表[新服务]
        var noItem_TPL = '{for list in MySoldOut}'
            ...
            +'  <div class="p-img">'
            +'      <a target="_blank" href="../../js/${list.wid}.html">'+imgStr+'</a>'
            +'  </div>'
            +'  <div class="p-name">'
            +'      <a target="_blank" title="${list.name}" href="../../js/${list.wid}.html">${list.name}</a>'
            +'  </div>'
            +'  <div class="p-price">'
...
//							$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'><span id='promise-ico'><a class='"+(pageConfig.product.isLOC2?"pico-onlineserver":"shouhoudaojia")+"' href='#none'></a></span>由<a href='../../js/"+$.getShopUrl(r)+"' target='_blank' clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>提供服务和售后"
//							+"<span id='loc_enddate'>"+(locSkuEndDate?("，"+locSkuEndDate):"。")+"</span>"+"</div>").appendTo("#summary-service");
//						}
//						else{
//							requestDeliveCash = true;
//							getPOPDeliveCash();
//							$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由<a href='../../js/"+$.getShopUrl(r)+"' target='_blank' clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>"+dfinfo+"发货，"
...
//					}
//					else if(r.type==2){
//						$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由<a href='../../js/"+$.getShopUrl(r)+"' "+(pageConfig.product.isFlashPurchase?"":"target='_blank'")+" clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>"+dfinfo+"发货，京东提供售后服务。"+iconDesc+"</div>").appendTo("#summary-service");
//					}
//					else if(r.type==5){
//						$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由<a href='../../js/"+$.getShopUrl(r)+"' "+(pageConfig.product.isFlashPurchase?"":"target='_blank'")+" clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>"+dfinfo+"发货，"+shinfo+iconDesc+"</div>").appendTo("#summary-service");
//					}
//				}
...
//                    var shoplinkhtml="<a href='../../js/"+$.getShopUrl(r)+"' target='_blank'>"+r.vender+"</a>";
...
function showProvinceStockDeliver(r){
    ...
    $('<div id="ypds-info"><a href="../../js/'+spuPageUrl+'" class="hl_blue" target="_blank">'+(r.totalCount-cutCount)+'个卖家在售</a><span class="hl_red">\u3000￥'+(r.minPrice+"")+'</span> 起</div>').insertAfter("#choose"); 
    spuVenderInfos = '<div class="mt"><span class="fl"><b>'+(pageConfig.product.cat[0]==1713?('<a href="../../js/'+spuPageUrl+'" target="_blank"><font style="color:#005EA7">'+(r.totalCount-cutCount)+'个卖家在售</font></a>'):'其他在售卖家')+'</b></span><span class="extra"><a href="../../js/'
...
(function(){
    ...
    if(window.itemShopJsona&&itemShopJsona.shopAd){
        shopTempArray.push('<div id="sp-ad" class="m" clstag="shangpin|keycount|product|pop-08"><a href="../../js/'+itemShopJsona.shopAd.adUrl+'" target="_blank" title="'+itemShopJsona.shopAd.title+'"><img data-lazyload="'+itemShopJsona.shopAd.adImg+'" alt="'+itemShopJsona.shopAd.title+'"/></a></div>');
    }
